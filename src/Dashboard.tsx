...
const App = () => {
  ...
  // Calculos para el Consumo Energético (Gauge)
  ...
  return (
    <div className="content">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-4 mx-8 lg:mx-20 gap-5 mt-6 lg:h-[45vh]">
        ...
        <div className="lg:col-span-3 rounded-2xl overflow-hidden shadow-lg border border-border h-full relative group bg-black">
          <img src="robot-welcome.webp" alt="Robot de bienvenida." className="w-full h-full object-cover object-left opacity-90" />
          {/* Overlay azul sutil para la imagen */}
          <div className="absolute inset-0 bg-primary/20 mix-blend-overlay pointer-events-none"></div>

          <div className="absolute inset-0 flex items-center justify-start p-4 pl-8 lg:pl-16">
            <div className="px-8 py-6 flex flex-col items-center justify-center text-center gap-1 transform group-hover:scale-105 transition-transform duration-300 bg-primary/10 backdrop-blur-xl border border-white/30 shadow-[0_8px_32px_0_rgba(0,0,0,0.1)] shadow-inner rounded-3xl min-w-[240px]">

              <div className="flex flex-col items-center gap-1 mb-2">
                <div className="p-2 bg-primary/20 rounded-xl text-white shadow-inner border border-white/20">
                  <Battery className="w-6 h-6 drop-shadow-md" strokeWidth={2.5} />
                </div>
                <h2 className="text-[10px] font-bold text-white/90 uppercase tracking-widest drop-shadow-sm">
                  Consumo Energético
                </h2>
              </div>

              {/* Arc Gauge */}
              <div className="relative flex flex-col items-center justify-center mt-2 w-full px-2">
                <svg viewBox="0 0 140 80" className="w-full h-auto drop-shadow-md">
                  {/* Background Arc */}
                  <path
                ...
                <div className="absolute bottom-0 flex flex-col items-center justify-end pb-1">
                  <span className="text-4xl font-black text-white tracking-tighter drop-shadow-md leading-none">
                    {avgWatts}
                  </span>
                  <span className="text-white/80 text-[10px] font-bold uppercase tracking-wider mt-1 drop-shadow-sm">W Promedio</span>
                </div>
              </div>

              {/* Min/Max Labels */}
              <div className="flex justify-between w-full px-4 mt-2">
                <span className="text-white/50 text-[10px] font-bold tracking-wider">0W</span>
                <span className="text-white/50 text-[10px] font-bold tracking-wider">MÁX: {maxWatts}W</span>
              </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              {pageOffset === 0 ? (
                ...
                <span className="relative flex h-3 w-3 shrink-0 bg-muted-foreground rounded-full"></span>
              )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 bg-card border border-border rounded-lg px-2 py-1 shadow-sm hover:bg-muted/50 transition-colors">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setPageOffset(0); // Volver al presente al filtrar
                  }}
              ...
              <div className="flex items-center gap-1 bg-card border border-border rounded-lg p-0.5 shadow-sm">
                <button
                  ...
                  title="Ir al pasado (registros anteriores)"
                >
                ...
                <button
                  ...
                  className="p-1 rounded-md text-foreground hover:bg-muted disabled:opacity-30 disabled:hover:bg-transparent transition-colors"
                  title="Ir al futuro (registros recientes)"
                >
      ...
      {/* Bottom Section: 4 Columns (Alineado con arriba) */}
      <section className="mx-8 lg:mx-20 mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
          ...
          {/* Col 3: Chart 3 (Termina exactamente donde la imagen) */}
          ...
          {/* Col 4: Chart 4 (Alineada bajo las otras dos gráficas) */}
          <div className="lg:col-span-1 h-[250px] lg:h-full">
            <SensorChart
